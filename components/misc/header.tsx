...
const Header = () => {
  ...
  return (
    <header className={`fixed w-full z-30 shadow-xl transition duration-300 ease-in-out ${!top && ' backdrop-blur-sm shadow-lg'}`}>
      <div className="max-w-6xl mx-auto px-5 sm:px-6 bg-slate-900">
        <div className="flex items-center justify-between h-16 md:h-20">
          <h2 className="text-pink-700 shrink-0 mr-4 text-2xl font-bold tracking-tight md:tracking-tighter leading-tight">
          ...
          <ul className="flex grow justify-end flex-wrap items-center">
            <li>
              <button className="w-4 h-4 my-auto mx-2 border-black" aria-label="Search" onClick={() => setSearching(!searching)} disabled={searching}>
                <svg className="w-4 h-4 fill-current text-pink-700" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
